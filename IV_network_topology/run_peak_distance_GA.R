...
load("/rsrch5/home/epi/stbresnahan/scratch/PFAS/data_for_distance_analysis_GA.RDS")  # loads all_module_mediation_df, pfas_order, tpte_values
...
## ---- Save output ----
out_dir <- "/rsrch5/home/epi/stbresnahan/scratch/PFAS/peak_distances_GA"
